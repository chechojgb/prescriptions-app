...
// FIX: Explicitly type payload and label props instead of inheriting from Tooltip
...
// FIX: Define legend payload type explicitly instead of using Pick<LegendProps, ...>
